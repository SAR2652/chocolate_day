					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
								<img src="{{asset('img/ves_logo.png')}}" alt="ves logo">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
							...
							<div class="header-search">
								<form>
									<select class="input-select">
										...
										<option value="1">Dairy Milk</option>
										<option value="1">Kitkat</option>
									</select>
					...
					<div class="row">
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<p>This is the official website for Chocolate Day at VESIT, Chembur</p>
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>VESIT, Chembur</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+919987623330</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>2016.sarvesh.relekar@ves.ac.in</a></li>
								</ul>
							</div>
						</div>
